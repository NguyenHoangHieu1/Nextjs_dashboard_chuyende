...
export const metadata: Metadata = {
  title: "Agent Profile | TailAdmin - Real Estate Dashboard",
  description:
    "This is the agent profile page for TailAdmin - Real Estate Dashboard",
};
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                  Dedicated real estate professional with over 10 years of
                  experience in the local market. Specializing in luxury homes
                  and investment properties. My commitment is to provide
                  exceptional service and help clients find their perfect home
                  or maximize their investment returns.
                </p>
              </div>
